...
public class OSFAPICallGetNBMapCustNtFndTest extends TestBase  {
	...
	public void VerifyOSFGetNBAMappingCustomerNotFoundAPIcallSuccessfully() {
		...
		try {
			...
			System.setProperty("javax.net.ssl.trustStoreType", "JKS");
		 	  ...
		 	  json = general_ReadProperty("OSF_Json_MapCustNF");
