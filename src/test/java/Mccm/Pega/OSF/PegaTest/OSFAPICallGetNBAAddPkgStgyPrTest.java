...
public class OSFAPICallGetNBAAddPkgStgyPrTest extends TestBase  {
	...
	public void VerifyOSFAddPackagesStrategyPropositionAPIcallSuccessfully() {
		...
		try {
			...
			System.setProperty("javax.net.ssl.trustStoreType", "JKS");
		 	  ...
		 	  json = general_ReadProperty("OSF_Json_Addpckg");
