...
public class OSFAPICallProFdMobBanTest extends TestBase  {
	...
	public void VerifyOSFACCOUNTMAPPING_MobileBAN_MobileSubscr_IHAPIcallSuccessfully() {
		...
		try {
			...
			System.setProperty("javax.net.ssl.trustStoreType", "JKS");
		 	  ...
		 	  json = general_ReadProperty("OSF_Json_MobBan");
