...
public class OSFAPICallGetNBAMultiCustOffUnvTest extends TestBase  {
	...
	public void VerifyOSFMultipleAccountsCustomerUnavailableOfferUnavailabilityAPIcallSuccessfully() {
		...
		try {
			...
			System.setProperty("javax.net.ssl.trustStoreType", "JKS");
		 	  ...
		 	  json = general_ReadProperty("OSF_Json_MultiCustUnv");
