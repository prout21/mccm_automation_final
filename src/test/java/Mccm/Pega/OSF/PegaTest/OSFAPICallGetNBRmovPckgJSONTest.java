...
public class OSFAPICallGetNBRmovPckgJSONTest extends TestBase  {
	...
	public void VerifyOSFRemovePackagesJSONAPIcallSuccessfully() {
		...
		try {
			...
			System.setProperty("javax.net.ssl.trustStoreType", "JKS");
		 	  ...
		 	  json = general_ReadProperty("OSF_Json_Rmovpckg");
