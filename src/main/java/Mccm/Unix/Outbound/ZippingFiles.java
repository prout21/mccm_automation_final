...
public class ZippingFiles {
	...
	public static void main(Object args) {
	    ...
	    //String command="ls -lrt";
		   String command="sh /opt/SP/data/mccm02/temp/zip_csv.sh";
		//   String command="gzip SCHIERARCHY_20200515010201.csv";	    
		   
		   // String command="gzip /opt/SP/mccm/SYSN/mccm_dataload/import/input"; 
		   // String command="gzip /opt/SP/mccm/SYSN/mccm_dataload/import/inpu";
	  //  String command="ksh /opt/SP/mccm/SYSN/mccm_dataload/import/scr";
	  //  String command="ksh /opt/SP/mccm/SYSN/mccm_dataload/import/scr";
