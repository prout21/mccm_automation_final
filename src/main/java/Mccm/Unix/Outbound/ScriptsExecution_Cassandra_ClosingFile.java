...
public class ScriptsExecution_Cassandra_ClosingFile extends App_Unix_Outbound_Test {
...
//	public static String ScriptsExecution_Cassandra;
	public static String ScriptsExecution_Cassandra_Closing;
	...
	public static void main(Object args) {
		...
		String command=general_ReadProperty("ScriptsExecution_Cassandra_Closing");
		...
		try{        
			...
			channel.disconnect();
			session.disconnect();
			System.out.println("ScriptsExecution_Cassandra_ClosingFile Run Done");
		}catch(Exception e){
			e.printStackTrace();
		}
