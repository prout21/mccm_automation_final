...
public class OSFAPICallProFdCableTest extends TestBase  {
	...
	public void VerifyOSFACCOUNTMAPPING_Cable_CableSubscr_IHAPIcallSuccessfully() {
		...
		try {
			...
			System.setProperty("javax.net.ssl.trustStoreType", "JKS");
		 	  ...
		 	  json = general_ReadProperty("OSF_Json_Cable");
