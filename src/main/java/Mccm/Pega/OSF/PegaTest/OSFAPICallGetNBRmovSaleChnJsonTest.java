...
public class OSFAPICallGetNBRmovSaleChnJsonTest extends TestBase  {
	...
	public void VerifyOSFRemovSalesChannelJSONCommissionPointsPropositionAPIcallSuccessfully() {
		...
		try {
			...
			System.setProperty("javax.net.ssl.trustStoreType", "JKS");
		 	  ...
		 	  json = general_ReadProperty("OSF_Json_RmovSaleCh");
