...
public class OSFAPICallGetNBAAddSaleChanTest extends TestBase  {
	...
	public void VerifyOSFAddingSalesChannelCommissionPointsPropositionAPIcallSuccessfully() {
		...
		try {
			...
			System.setProperty("javax.net.ssl.trustStoreType", "JKS");
		 	  ...
		 	  json = general_ReadProperty("OSF_Json_AddScale");
