...
public class PageMrktEtoEFlowReSchduOtbd extends TestBase  {
	...
	public void NBABatchReschdeleCampaignSuccessfull() throws InterruptedException, AWTException {
		...
		while(itr.hasNext())
		{
			...
			String getTextOnPage111 = "",getTextOnPage112 = "";

					try {
						WebElement element111 = driver.findElement(By.xpath("//span[contains(text(),'Wait for Scheduled Run:')]"));

						getTextOnPage111 = element111.getText();
					...
					try {
						WebElement element112 = driver.findElement(By.xpath("//span[text()='Reschedule']"));

						getTextOnPage112 = element112.getText();
					...
					if(getTextOnPage111.equals("Wait for Scheduled Run"))  {
 
						driver.findElement(By.xpath("//span[contains(text(),'Wait for Scheduled Run:')]")).click();
						driver.findElement(By.xpath("//span[text()='Reschedule']")).click();
						System.out.print("come2");
					}
						else if (getTextOnPage112.equals("Reschedule")) {
 
							driver.findElement(By.xpath("//span[text()='Reschedule']")).click();
							System.out.print("come1");
						}
				}
