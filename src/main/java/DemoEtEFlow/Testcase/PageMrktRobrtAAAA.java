...
public class PageMrktRobrtAAAA extends TestBase  {
...
//	
//     Thread.sleep(8000);
// 	 driver.findElement(By.xpath("//input[@type='text'][@name='$PpyDisplayHarness$ppySearchText']")).click( );
// 	 Thread.sleep(8000);
// 	 
//      Thread.sleep(8000);
//  	 driver.findElement(By.xpath("//span[@class='workarea_header_titles']")).click( );
//  	 Thread.sleep(8000);
//  	 
    // driver.findElement(By.xpath("//text()[.='Create']/ancestor::button[1]")).click( );
...
//     
//     }
    //l driver.switchTo().frame("PegaGadget1Ifr");
//      Thread.sleep(8000);
...
//     driver.switchTo().defaultContent();
 ...
 //    new WebDriverWait(driver, 10).until(ExpectedConditions.frameToBeAvailableAndSwitchToIt(By.xpath("//*[@class='pi pi-caret-down']")));
  //   new WebDriverWait(driver, 10).until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@class='pi pi-caret-down']"))).click();
